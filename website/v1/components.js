...
(function() {
    ...
    const ALL_GAMES = [
        { id: 'lastwordszombies', title: 'Last Words Zombies', emoji: '🤖', path: 'lastwordszombies', desc: 'A high-intensity 3D cyberpunk typing survival game. Decrypt approaching rogue cyber-units before they breach your mainframe terminal.', tags: ['Action', 'Typing'], bg: 'linear-gradient(135deg, #09090e 0%, #0f1016 50%, #00ffcc 100%)', featured: true, weight: 12 },
