...
(function() {
    ...
    const ALL_GAMES = [
        ...
        { id: 'lastwordszombies', title: 'Last Words: Cyber Breach', emoji: '🤖', path: 'lastwordszombies', desc: 'A fast-paced 3D typing survival game set in a compromised cybernetic corridor. Decrypt access keys to overload invading rogue cyborg units.', tags: ['Action', 'Typing'], bg: 'linear-gradient(135deg, #09090e 0%, #0f1016 50%, #00ffcc 100%)', featured: true, weight: 9 },
