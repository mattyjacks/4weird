...
export default function sitemap(): MetadataRoute.Sitemap {
  const fixed = ["", "/games", "/xonotic", "/buddy", "/my/usage/", "/academy", "/pricing", "/tech", "/privacy", "/terms", "/accessibility", "/spaceships", "/web-apps", "/vibecodeworker", "/vibecodeworker/overview", "/vibecodeworker/hub", "/vibecodeworker/run", "/vibecodeworker/full", "/vibecodeworker/phone", "/vibecodeworker/docs", "/vibecodeworker/demo", "/teams", "/desktop", "/blender", "/agents", "/clans", "/leaderboards", "/lobbies", "/bot/setup", "/bot/bclans", "/account", "/my/rights", "/docs", "/docs/about", "/docs/getting-started", "/docs/playing-games", "/docs/vibe-coins", "/docs/clans", "/docs/bots", "/docs/agents-compute", "/docs/game-ai-buddy", "/docs/vibecodeworker", "/docs/explore-more", "/docs/privacy-safety", "/docs/faq"];
