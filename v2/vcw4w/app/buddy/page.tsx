  ...
  return (
    <div className="bg-slate-950 text-white">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-16">
        ...
        <Suspense
          fallback={
            <p role="status" className="mt-6 rounded-2xl border border-white/10 bg-white/[.03] p-5 text-sm text-slate-400">
...
// the picker, the per-user GamingBuddy widget, and the cached guide copy.
