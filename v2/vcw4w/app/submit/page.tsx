...
export const metadata: Metadata = {
  ...
  description: `Upload your game as a .zip (69 MB max) with a Vercel-style game root. Automatic safety scan: safe, warning, unsafe, or denied. ${SUBMIT_CUT_NOTE}`,
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-3xl px-5 py-16">
        ...
        <p className="mt-4 text-slate-300">
          Zip your game (max <strong>69 MB</strong>), tell us the{" "}
