...
async function CachedSupportHeader() {
  ...
  return (
    <header className="space-y-2">
      ...
      <h1 className="text-2xl font-black">Back the weird you love.</h1>
      ...
      <details className="max-w-2xl rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-slate-300">
        <summary className="cursor-pointer font-semibold text-slate-200">Coins, Crowns & legal terms</summary>
        <p className="mt-1">
