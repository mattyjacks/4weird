    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-4xl px-5 py-14">
        ...
        <p className="mt-4 text-slate-300">
          ...
          first, then tick â€œInstalledâ€ below.
        </p>
        <ul className="mt-4 list-disc space-y-1 pl-5 text-sm text-slate-400">
          <li>
            GPU boosted only â€” the remote uses RunPod GPUs (fastest vision, Xonotic&apos;s native client is GPL-3.0+).
          </li>
          <li>
          ...
          <li>4weird catalog games stay on-site only â€” this page never unlocks off-site for them.</li>
        ...
        <p className="mt-6 text-sm text-slate-400">
          ...
          <Link href="/agents" className="text-cyan-300 hover:underline">
            Rent an agent / Xonotic server â†’
          </Link>
        </p>
      </section>
    </main>
