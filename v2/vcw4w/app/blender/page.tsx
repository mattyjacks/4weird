    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-4xl px-5 py-14">
        ...
        <p className="mt-4 text-slate-300">
          Blender is the free, open-source 3D suite (blender.org): you build a scene â€” models, materials, lights,
          camera â€” and animate it on a timeline of <b className="text-white">frames</b> (24 or 30 per second).
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
            <h2 className="font-bold">1 Â· Bring a scene</h2>
            <p className="mt-2 text-sm text-slate-400">
              ...
              â€” or make the classic in 2 minutes: open Blender, keep the default cube, move it, press{" "}
              <kbd className="rounded bg-black/50 px-1">I</kbd> â†’ Location on frames 1 and 60, save the .blend.
            </p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
            <h2 className="font-bold">2 Â· Pick frames</h2>
            <p className="mt-2 text-sm text-slate-400">
              Frames 1â€“60 at 24 fps is a 2.5-second clip. One job covers up to {BLENDER_MAX_FRAMES} frames; longer
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
            <h2 className="font-bold">3 Â· Get the mp4</h2>
            <p className="mt-2 text-sm text-slate-400">
              The worker uploads your mp4 to your storage and exits itself â€” billing ends with no clicks. If the
        ...
        <p className="mt-6 text-sm text-slate-400">
          ...
          <Link href="/desktop" className="text-cyan-300 hover:underline">
            Rent a GPU graphical desktop â†’
          </Link>
        </p>
      </section>
    </main>
