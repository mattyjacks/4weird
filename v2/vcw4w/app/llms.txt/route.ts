import { FACTS, OPERATOR, SITE_NAME, SITE_URL } from "@/lib/seo";
...
- Coin packs: 500 / 1500 / 5000 / 25000 coins ($5 / $15 / $50 / $250). There is no 100-coin pack.
...
- Docs: ${SITE_URL}/docs (start: ${SITE_URL}/docs/getting-started, coins: ${SITE_URL}/docs/vibe-coins, FAQ: ${SITE_URL}/docs/faq)
