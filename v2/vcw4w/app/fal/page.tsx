...
export const metadata: Metadata = {
  ...
  title: "fal.ai Studio â€” 15 magical media tools | 4weird",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-6xl px-5 py-16">
        <p className="text-sm font-semibold uppercase tracking-widest text-fuchsia-300">fal.ai Â· Game dev + coding</p>
        <h1 className="mt-2 text-4xl font-black">âœ¨ fal.ai Studio â€” 15 ways to make magic</h1>
