...
export const metadata: Metadata = {
  ...
  description:
    "Hire a swarm of AI agents as one chatbot interface: custom system prompts, auto tool use including VibeCodeWorker OpenCode and the DeepSeek harness, metered per turn with the 25% cut included.",
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.3em] text-violet-300">Gemini-Spark-style chat</p>
