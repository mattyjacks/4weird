...
export default function VocrehabExportPage() {
  return (
    <main className="vocrehab-export-page mx-auto w-full max-w-3xl px-4 py-8">
      <h1 className="text-2xl font-bold text-stone-900">Your data, to take with you</h1>
      ...
      <p className="mt-4 text-sm text-stone-600">
        Know your rights: <Link href="/vocrehab/privacy" className="font-medium text-emerald-700 underline">consent, retention, and deletion</Link>.
      </p>
    </main>
  );
}
