...
/**
 * /mmorpg browser (web lane).
 *
 * Tries a live fetch of GET /api/mmorpg/quote first; ANY failure (offline,
...
export function MmorpgBrowser() {
  ...
  useEffect(() => {
    ...
    async function tryLive() {
      try {
        const res = await fetch("/api/mmorpg/quote", { cache: "no-store" });
