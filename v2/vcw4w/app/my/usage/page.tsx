...
async function UsageBody() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-14 sm:py-20">
      ...
      <Suspense fallback={<p className="mt-8 text-sm text-slate-400">Loading your compute ledger…</p>}>
        <UsageClient />
      </Suspense>
...
export default function UsagePage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <Suspense
        fallback={
          <section className="mx-auto max-w-6xl px-5 py-14 sm:py-20" aria-busy="true" aria-label="Loading usage">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-300">4weird.com/my/usage/</p>
            <h1 className="mt-3 text-4xl font-black sm:text-5xl">My compute usage</h1>
            <p className="mt-4 max-w-3xl text-slate-300">Your itemized compute ledger loads privately after sign-in.</p>
