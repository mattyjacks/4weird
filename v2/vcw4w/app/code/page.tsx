...
export default function CodeLandingPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-5xl px-4 py-3.5">
        ...
        <details className="mt-1 max-w-3xl text-sm text-slate-300">
          ...
          <p className="mt-1">
            ...
            submission, plus a file preview and .zip download for safe
            packages. Paste a submission ID below to jump straight to its
            audit.
          </p>
        </details>
        ...
        <div className="mt-3 grid items-start gap-3 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link
              href="/submit"
              className="inline-block w-full rounded-full bg-cyan-600 px-5 py-2 text-center text-sm font-black text-white"
            >
              Submit your game →
            </Link>
          </div>
        ...
        {/* DS-UXP2-14 (spec p41): tabbed info — CSS-only radio tabs, zero
            handlers; every heading, link, and FAQ stays mounted. */}
        <div className="mt-3">
          <input
            id="code-tab-overview"
            name="code-info-tab"
            type="radio"
            defaultChecked
          ...
          <input
            ...
            name="code-info-tab"
            type="radio"
            className="peer/guide sr-only"
          />
          <input
            id="code-tab-faq"
            name="code-info-tab"
            type="radio"
            className="peer/faq sr-only"
          />
          <div
            aria-label="Audit information"
            className="flex flex-wrap gap-1 rounded-full border border-white/10 bg-white/[.04] p-1"
          >
            <label
              htmlFor="code-tab-overview"
              className="cursor-pointer rounded-full px-4 py-1.5 text-sm font-bold text-slate-300 hover:text-white peer-checked/overview:bg-cyan-600 peer-checked/overview:text-white"
            >
              Overview
            </label>
            <label
              htmlFor="code-tab-guide"
              className="cursor-pointer rounded-full px-4 py-1.5 text-sm font-bold text-slate-300 hover:text-white peer-checked/guide:bg-cyan-600 peer-checked/guide:text-white"
            >
              Audit Guide
            </label>
            <label
              htmlFor="code-tab-faq"
              className="cursor-pointer rounded-full px-4 py-1.5 text-sm font-bold text-slate-300 hover:text-white peer-checked/faq:bg-cyan-600 peer-checked/faq:text-white"
            >
              FAQs
            </label>
          </div>
          ...
          <section
            aria-label="Overview"
            className="mt-3 hidden peer-checked/overview:block"
          >
          ...
          <section
            ...
            className="mt-3 hidden space-y-3 peer-checked/guide:block"
          >
            <div className="rounded-2xl border border-white/10 bg-white/[.04] p-4">
              ...
              <p className="mt-1 text-sm text-slate-300">
                ...
                <strong>game root</strong> inside the .zip (the folder where
                your index.html lives), and our scanner marks it{" "}
                <strong>safe</strong>, <strong>warning</strong>,{" "}
                <strong>unsafe</strong>, or <strong>denied</strong>. Malware,
                keyloggers, cybercrime tools, and sexual content are
                hard-denied: quarantined, never served, queued for human
                moderators.
              </p>
            </div>
            ...
            <details className="rounded-2xl border border-white/10 bg-white/[.04] p-4">
              ...
              <p className="mt-1 text-sm text-slate-300">
                Automating submissions or reviews? Claim a bot identity and
                issue a bot key on{" "}
                ...
                . Bot keys act as you, so keep them secret and rotate any time
          ...
          <section
            aria-label="FAQs"
            className="mt-3 hidden peer-checked/faq:block"
          >
