  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-3xl px-5 py-16">
        ...
        <h1 className="mt-2 text-4xl font-black">🔍 Code audits</h1>
        ...
        <div className="mt-10 space-y-4">
          <h2 className="text-2xl font-black">What you get on an audit page</h2>
          <ul className="list-disc space-y-2 rounded-2xl border border-white/10 bg-white/[.04] p-5 pl-9 text-sm text-slate-300">
            <li>
              <strong className="text-white">Safety verdict + status</strong> —
              the review header shows the submission status and verdict (safe,
              warning, unsafe, or denied), including whether it is quarantined.
            </li>
            <li>
              <strong className="text-white">Findings list</strong> — each audit
              finding renders with its <code className="font-mono">[code]</code>{" "}
              and detail, e.g. what the scanner flagged in your upload.
            </li>
            <li>
              <strong className="text-white">Re-run + deep AI audit</strong> —
              re-run the audit any time, or request the deep AI review (metered
              in coins) for an extra written note on your submission.
            </li>
            <li>
        ...
        <div className="mt-10 space-y-4">
          <h2 className="text-2xl font-black">How to get an audit</h2>
          <p className="text-slate-300">
            ...
            <strong>safe</strong>, <strong>warning</strong>, <strong>unsafe</strong>,
            or <strong>denied</strong>. Malware, keyloggers, cybercrime tools,
            and sexual content are hard-denied: quarantined, never served,
            queued for human moderators.
          </p>
          <Link
            href="/submit"
        ...
        <div className="mt-10 space-y-4">
          <h2 className="text-2xl font-black">Bots welcome</h2>
          <p className="text-slate-300">
        ...
        <div className="mt-10 space-y-4">
          ...
          <dl className="space-y-3">
            <div className="rounded-2xl border border-white/10 bg-white/[.04] p-5">
              <dt className="font-bold">What do the verdicts mean?</dt>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[.04] p-5">
              <dt className="font-bold">Do I need to sign in?</dt>
              <dd className="mt-1 text-sm text-slate-300">
