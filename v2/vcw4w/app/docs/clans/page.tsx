  ...
  return (
    <article>
      <DocsHero
        ...
        lede={<>Gamer/coder social network: forums + Discord-style chat + images + markdown + upkeep wallets + XP — in three flavors. Reading is public; posting needs an account.</>}
        stats={[
          ["3", "clan species"],
          ["≤1 MB", "image uploads"],
          ["~0.26 🪙", "upkeep / day*"],
