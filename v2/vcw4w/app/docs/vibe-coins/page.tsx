  ...
  return (
    <article>
      ...
      <SectionHead
        ...
        body="When you pay 400 coins ($4.00) for compute, 100 goes to the platform and 300 to the provider — but you only ever see the gross 400. Same rule for game rentals, clan fees, game AI, Buddy turns, and team cloud. Your receipt is /my/usage/."
      />
      <SplitBar />
      ...
      <ul className="mt-5 space-y-2 text-sm leading-relaxed text-muted-foreground">
        ...
        <li className="rounded-xl border border-border bg-card p-3">📜 <strong className="text-foreground">Coins are licensed features</strong> — no cash value, non-transferable, purchases final except where law requires otherwise (<Link className="underline" href="/terms">Terms §8</Link>).</li>
      </ul>
