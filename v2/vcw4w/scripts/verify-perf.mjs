...
must(discord.includes("reactionsByMessage"), "clan-discord must group reactions once (O(1) lookup)");
must(discord.includes("document.hidden"), "clan-discord must skip polls when the tab is hidden");
