...
// frontend lives at v2/desktop/code/frontend; never put new work in old-v1.
const pairs = [[join(oldRoot, "vcw"), "vcw"], [join(desktopRoot, "code", "frontend"), "vibecodeworker-legacy"]];
