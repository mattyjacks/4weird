...
// Exactly 15 ops, all with model endpoints + pricing.
...
for (const model of ["fal-ai/flux/schnell","fal-ai/kling-video","fal-ai/whisper","fal-ai/trellis","fal-ai/birefnet"]) {
...
// Cloud catalog carries all 15 fal services with the 25% note.
for (const op of expected) {
...
// GUI: studio renders all 15 tools + honest state; page + nav link exist.
...
// Standard harness + ledger: VCW status advertises the 15 ops, usage breaks out fal.
...
console.log("fal.ai Studio integrity OK — 15 magical tools, 25% included.");
