...
export const DOCS_DATA: DocEntry[] = [
  ...
  { href: "/docs/mmorpg", label: "MMORPG realms", blurb: "Servers, roles, kid-safe play", icon: "🐉", card: "from-emerald-500/25 via-green-500/10 to-teal-500/25" },
  { href: "/docs/mmorpg/hosting", label: "Hosting a realm", blurb: "Rent + configure a server", icon: "🖥️", card: "from-blue-500/25 via-indigo-500/10 to-violet-500/25" },
  { href: "/docs/mmorpg/age-bands", label: "MMORPG age bands", blurb: "Kid-safe matchmaking", icon: "🛡️", card: "from-amber-500/25 via-yellow-500/10 to-orange-500/25" },
  { href: "/docs/mmo/player", label: "MMO player guide", blurb: "Join a shard, split the meter", icon: "🎮", card: "from-emerald-500/25 via-teal-500/10 to-cyan-500/25" },
  { href: "/docs/mmo/host", label: "MMO host guide", blurb: "Rent a world, set the subsidy", icon: "🖥️", card: "from-blue-500/25 via-indigo-500/10 to-violet-500/25" },
  { href: "/docs/mmo/safety", label: "MMO safety", blurb: "Three bands, kid-safe shards", icon: "🛡️", card: "from-teal-500/25 via-emerald-500/10 to-cyan-500/25" },
  { href: "/docs/mmo/faq", label: "MMO FAQ", blurb: "Billing and access answers", icon: "❓", card: "from-indigo-500/25 via-violet-500/10 to-sky-500/25" },
  ...
  { href: "/docs/vibecodeworker", label: "VibeCodeWorker", blurb: "QA runs, bugs, handoffs, gateway keys", icon: "⚙️", card: "from-orange-500/25 via-amber-500/10 to-stone-500/20" },
