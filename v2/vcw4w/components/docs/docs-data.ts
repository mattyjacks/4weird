...
export const DOCS_DATA: DocEntry[] = [
  ...
  { href: "/docs/mmo", label: "MMORPG realms", blurb: "Servers, roles, kid-safe play", icon: "🐉", card: "from-emerald-500/25 via-green-500/10 to-teal-500/25" },
  { href: "/docs/mmo/hosting", label: "Hosting a realm", blurb: "Rent + configure a server", icon: "🖥️", card: "from-blue-500/25 via-indigo-500/10 to-violet-500/25" },
  { href: "/docs/mmo/age-bands", label: "MMORPG age bands", blurb: "Kid-safe matchmaking", icon: "🛡️", card: "from-amber-500/25 via-yellow-500/10 to-orange-500/25" },
