...
export function DailyClaim() {
  ...
  async function claim() {
    ...
    try {
      ...
      setMessage(body.claimed ? `+${body.coins} coins + 💌x${body.love_letters ?? 1}! Day ${body.streak} streak.` : `Already claimed today. Streak: day ${body.streak}.`);
      if (body.claimed) {
