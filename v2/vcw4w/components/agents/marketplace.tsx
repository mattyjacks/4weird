  ...
  return (
    <div>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        ...
        <label className="flex min-w-48 flex-1 items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
          Search
          <input
            value={query}
        ...
        <button
          ...
          className="rounded-md border border-slate-700 px-2 py-1 text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white"
        >
          Reset
        </button>
      </div>
        ...
        {visible.map((l) => {
          ...
          return (
            ...
            >
              ...
              {desc && <p className="mt-1 text-xs text-slate-600 dark:text-slate-500">{desc}</p>}
              <p className="mt-3 text-xl font-black text-cyan-300">
                up to {formatUsd(l.price_cents_per_hour)}
                <span className="text-sm font-normal text-slate-600 dark:text-slate-400"> /hour max, gross</span>{" "}
