...
export const DOCS_COLUMN: FooterDataColumn = {
  ...
  links: [
    ...
    { href: "/docs/mmo", label: "🐉 MMORPG Guide", blurb: "Realms, roles, and kid-safe play." },
    { href: "/docs/mmo/hosting", label: "🖥️ Hosting a Realm", blurb: "Rent, configure, and run a server." },
    { href: "/docs/mmo/age-bands", label: "🛡️ Age Bands", blurb: "Kid-safe matchmaking by age." },
