    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-amber-300/40 bg-amber-300/10 px-4 py-3 text-sm text-amber-100">
        <strong>
          ...
          <InfoTip text="Each coin lot lasts one year. Spending always uses the oldest coins first." label="Coin expiry: one year, oldest first" />
        </strong>{" "}
      ...
      <div>
        <h2 className="text-xl font-bold">
          Coin packs{" "}
          <InfoTip text="Fixed packs are quick. Custom lets you pick any whole-coin count. Same price: 1 cent per coin." label="Coin packs vs custom amount" />
        </h2>
      ...
      <section className="rounded-2xl border border-white/10 bg-white/[.04] p-6">
        <h3 className="text-xl font-bold">
          Custom amount{" "}
          <InfoTip text="Pick any whole-coin count in range, at 1 cent per coin. Same expiry as packs." label="Custom amount: 500 to 100,000 coins" />
        </h3>
      ...
      <CompactDetails summary="Can I get a refund? Do coins expire?">
