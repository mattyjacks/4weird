(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(5, {
        dialogueBefore: [
            { speaker: 'Valley Net', text: 'Hades is jamming all sub-light frequencies from the array. Relay 09 below must be re-aligned by hand - fifteen flying skulls coil-guard the chamber, twenty-five hostiles total.', portrait: '👱🏻‍♀️' },
            ...
            { speaker: 'Valley Net', text: 'Breach on floor 5; the relay chamber sits on the warden floor one descent down - floor 6 - where the Corrupted Drone Array oversees the jamming. Destroy the skulls, clear the chamber, and I get our sky back.', portrait: '👱🏻‍♀️' },
        ...
        dialogueAfter: [
            { speaker: 'Valley Net', text: 'UPLINK ONLINE! Relay 09 aligned - planetary sensors tracking Hades’ orbital movements. The sky is ours again.', portrait: '👱🏻‍♀️' },
