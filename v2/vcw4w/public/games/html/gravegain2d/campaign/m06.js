(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(6, {
        dialogueBefore: [
            ...
            { speaker: 'Valley Net', text: 'Warning: toxic cloud density rising — the vents cannot be purged while the warden lives. Destroy the Chem-Golem first, then the purge sequence can run.', portrait: '🤖' },
        ...
        dialogueAfter: [
            ...
            { speaker: 'Valley Net', text: 'Toxicity falling across the sub-levels. Vents purged, vats sterilized. Botany Core breathes again.', portrait: '🤖' }
        ],
