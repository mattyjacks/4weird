(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(4, {
        dialogueBefore: [
            ...
            { speaker: 'Valley Net', text: 'Overlay: you breach the Crimson Sand Redoubts on floor 4. The Berserker dens on the warden floor two descents down - floor 6. Human personnel maintain spacing from Raging friendlies.', portrait: '👱🏻‍♀️' },
        ...
        dialogueAfter: [
            ...
            { speaker: 'Valley Net', text: 'Redoubt siege broken. Clan gates holding, artillery standing down. The Southern Wastes are yours, soldier.', portrait: '👱🏻‍♀️' }
        ],
