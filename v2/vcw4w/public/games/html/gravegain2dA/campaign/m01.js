(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(1, {
        dialogueBefore: [
            { speaker: 'Valley Net', text: 'Dropship 420 is down in Sector Alpha. Fifteen freshly-risen hostiles converging on the crash site - crater-crawlers plus the memorial detail. Helmet seals LOCKED: MoonRock air kills in ninety seconds.', portrait: '👱🏻‍♀️' },
            ...
            { speaker: 'Valley Net', text: 'Tutorial protocol: move, aim, fire - the crater field is deliberately thin. Fifteen hostiles, no elites, no warden. Learn the rhythm here, soldier, because MoonRock only gets harder.', portrait: '👱🏻‍♀️' },
        ...
        dialogueAfter: [
            { speaker: 'Valley Net', text: 'LZ secured. Fifteen hostiles neutralized, zero array signatures in the sector. Survivors falling back to the perimeter - excellent shooting, soldier.', portrait: '👱🏻‍♀️' },
