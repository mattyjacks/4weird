(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(2, {
        dialogueBefore: [
            ...
            { speaker: 'Valley Net', text: 'Tactical overlay: you breach the grove vaults on floor 2. The warden floor is one descent down - floor 3 - where the Necromancer nests. Purge the 20 corruptors as you fight down to it.', portrait: '👱🏻‍♀️' },
        ...
        dialogueAfter: [
            ...
            { speaker: 'Valley Net', text: 'Grove sector cleansed. Magical-field readings stabilizing - the forest whispers its gratitude, soldier.', portrait: '👱🏻‍♀️' }
        ],
