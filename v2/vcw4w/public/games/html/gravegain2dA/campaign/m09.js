(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(9, {
        ...
        dialogueAfter: [
            { speaker: 'Valley Net', text: 'Perimeter breach successful. The doors to Lucifer Hades’ chamber stand open. Finish it.', portrait: '👱🏻‍♀️' },
            { speaker: 'Queen Aelindra', text: 'The four races hold the breach behind you. Walk into the dark, soldier - and bring back the dawn.', portrait: '🧝‍♀️' }
        ],
