...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'chem-thrall', count: 7, wave: 1 },
                { id: 'mire-strangler', count: 4, wave: 1 },
                { id: 'suture-horror', count: 4, wave: 2 },
                { id: 'furnace-hulk', count: 2, wave: 3 }
            ],
            boss: { id: 'boss-chem-golem-4d', name: 'TOXIC CHEM-GOLEM', hpMult: 1.35 },
            bossId: 'boss-chem-golem-4d',
            intro: [
