...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'orc-gore-shaman', count: 4, wave: 1 },
                { id: 'ash-reaper', count: 4, wave: 1 },
                { id: 'cinder-monk', count: 6, wave: 2 },
                { id: 'wail-choir', count: 3, wave: 3 }
            ],
            boss: { id: 'boss-orc-berserker-4d', name: 'HUGE ORC ZED BERSERKER', hpMult: 1.2 },
            bossId: 'boss-orc-berserker-4d',
            intro: [
