...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'vault-tick', count: 6, wave: 1 },
                { id: 'rust-knight', count: 4, wave: 1 },
                { id: 'dice-golem', count: 3, wave: 2 },
                { id: 'spark-imp', count: 5, wave: 2 }
            ],
            boss: { id: 'boss-high-thane-4d', name: 'DWARVEN ZED HIGH THANE', hpMult: 1.1 },
            bossId: 'boss-high-thane-4d',
            intro: [
