...
(function () {
    ...
    var RACES = {
        ...
        dwarf: { name: 'Dwarf', emoji: '🧔🏻', hp: 8, atk: 0, def: 1, spd: -1, blurb: 'Stout forge-kin. Extra bulk, slower boots.' },
        orc: { name: 'Orc', emoji: '🟢👹', hp: 5, atk: 1, def: 0, spd: 0, blurb: 'Fierce blood-kin. Heavy hits, honor-bound.' }
    };
