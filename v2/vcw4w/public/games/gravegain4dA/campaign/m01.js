...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'grave_husk_4d', count: 5, wave: 1 },
                { id: 'tesseract_golem', count: 3, wave: 1 },
                { id: 'marrow_skull_4d', count: 4, wave: 2 },
                { id: 'pentachoron_wraith', count: 3, wave: 2 }
            ],
            boss: { id: 'puttalot_fallen_caddie', name: 'GOBLIN ZED LEADER (RIFT-TORN)', hpMult: 0.9 },
            bossId: 'puttalot_fallen_caddie',
            intro: [
