...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'grave_husk_4d', count: 8, wave: 1 },
                { id: 'hex_cultist_4d', count: 5, wave: 1 },
                { id: 'rift_qubit_bat', count: 4, wave: 2 },
                { id: 'hyper_slime', count: 3, wave: 2 }
            ],
            boss: { id: 'grove_seer_defiled', name: 'CORRUPTED ELVEN NECROMANCER', hpMult: 1.0 },
            bossId: 'grove_seer_defiled',
            intro: [
