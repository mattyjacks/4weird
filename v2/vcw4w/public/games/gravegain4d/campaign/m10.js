    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                ...
                { id: 'pentachoron_wraith', count: 5, wave: 2 },
                { id: 'tesseract_golem', count: 4, wave: 2 },
                { id: 'marrow_skull_4d', count: 6, wave: 3 }
            ],
            boss: { id: 'lucifer_hades_ascendant', name: 'ASCENDANT HADES (BOTH BRANES)',
                hpMult: 1.7,
                phases: [
            ...
            bossId: 'lucifer_hades_ascendant',
            intro: [
