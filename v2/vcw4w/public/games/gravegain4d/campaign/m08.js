...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'pentachoron_wraith', count: 7, wave: 1 },
                { id: 'pentachoron_wraith', count: 5, wave: 1 },
                { id: 'rift_qubit_bat', count: 6, wave: 2 },
                { id: 'tesseract_golem', count: 3, wave: 3 }
            ],
            boss: { id: 'goliath_fairway_reaper', name: 'BONE GOLIATH WARLORD', hpMult: 1.55 },
            bossId: 'goliath_fairway_reaper',
            intro: [
