...
(function () {
    ...
    try {
        ...
        window.GG4D_Campaign.register({
            ...
            spawns: [
                { id: 'grave_husk_4d', count: 6, wave: 1 },
                { id: 'hex_cultist_4d', count: 5, wave: 1 },
                { id: 'hyper_slime', count: 4, wave: 2 },
                { id: 'tesseract_golem', count: 4, wave: 2 },
                { id: 'hex_cultist_4d', count: 4, wave: 3 }
            ],
            boss: { id: 'patriarch_clint_undying', name: 'REANIMATED PATRIARCH CLINT PRIME', hpMult: 1.45 },
            bossId: 'patriarch_clint_undying',
            intro: [
