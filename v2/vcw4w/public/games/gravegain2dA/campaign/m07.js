(function() {
    ...
    window.GraveGainCampaign.registerMissionExtra(7, {
        dialogueBefore: [
            ...
            { speaker: 'Valley Net', text: 'Mission starts on floor 7 - the warden crypt lies deeper, on the floor divisible by 3. Fight down through the guardians and silence the reanimated patriarch.', portrait: '👱🏻‍♀️' },
        ...
        dialogueAfter: [
            ...
            { speaker: 'Valley Net', text: 'Crypt silent. Zero array signatures in the Honor halls. Clint Oldman sleeps - the living remember, soldier.', portrait: '👱🏻‍♀️' }
        ],
