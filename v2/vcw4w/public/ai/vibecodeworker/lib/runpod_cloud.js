...
function buildPodSpec(args = {}) {
  ...
  const body = {
    ...
    // Public tag documented by RunPod and available on Docker Hub.
    imageName: bootstrap ? 'runpod/pytorch:2.1.0-py3.10-cuda11.8.0-devel-ubuntu22.04' : (isSafeImage(args.image || '') ? args.image : DEFAULT_IMAGE),
    computeType: 'GPU',
    cloudType: 'SECURE',
