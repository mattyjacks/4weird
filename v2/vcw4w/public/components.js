...
(function() {
    ...
    const ALL_GAMES = [
        { id: 'lastwordszombies', title: 'Last Words Zombies', emoji: '🧟', path: 'lastwordszombies', desc: 'A high-intensity 3D zombie typing survival game. Banish shambling zombies before they overrun your graveyard barricade.', tags: ['Zombies', 'Typing', 'Horror', 'Survival'], bg: 'linear-gradient(135deg, #0a0f0a 0%, #1a2b1a 50%, #4a7c2e 100%)', featured: true, weight: 12 },
    ...
    function injectOtherGames() {
        ...
        // Determine Featured Game: Last Words Zombies. If currently on it, use Exit Waterfall Machine
        let featuredGameId = 'lastwordszombies';
        if (currentGameId.toLowerCase() === 'lastwordszombies') {
            featuredGameId = 'venturemechanically';
        }
