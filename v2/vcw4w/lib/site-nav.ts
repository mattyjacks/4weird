...
export const SITE_NAV_GROUPS: SiteNavGroup[] = [
  {
    ...
    links: [
      ...
      { href: "/xonotic", label: "🔫 Xonotic Arena", quick: "Watch a robot play arena rounds. Replays save straight to your account.", detail: "VibeCodeWorker plays Xonotic for you on a GPU-boosted RunPod remote. Off-site mode needs the desktop worker installed.\n\nRuns are metered by the minute in Vibe Coins, and replays save to your account. The robot handles hosting - you handle the aiming." },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/family", label: "👨‍👩‍👧‍👦 Family", quick: "Link parent and kid accounts. Kids spend only with approval.", detail: "Play together, safely. Parents create child accounts, fund wallets, and set controls from their own account.\n\nKids log in with a username handle - no email needed - and can never spend coins without approval." },
