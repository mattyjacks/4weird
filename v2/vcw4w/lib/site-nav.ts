...
export const SITE_NAV_GROUPS: SiteNavGroup[] = [
  {
    ...
    links: [
      ...
      { href: "/mmorpg", label: "🐉 MMORPG Realms", quick: "Browse and play community realms.", detail: "The realm browser. Find a kid-safe community server, see who is online, and jump in from your browser.\n\nEvery realm lists its age band and rules before you join. Want your own? Rent a server and set the rules yourself." },
      { href: "/mmorpg/rent", label: "🖥️ Rent a Realm", quick: "Host your own MMORPG server.", detail: "Your own always-on realm with your rules, your map, and your mods.\n\nPick a size, pay by the minute in Vibe Coins, and invite friends with a link. Pause anytime - the world saves." },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/docs/mmorpg", label: "🐉 MMORPG Guide", quick: "Realms, roles, and kid-safe play.", detail: "How MMORPG realms work: picking a server, age bands, and staying safe while playing with others.\n\nStart with a public realm that matches your age band. Every realm shows its rules before you join, and mods keep the peace." },
      { href: "/docs/mmorpg/hosting", label: "🖥️ Hosting a Realm", quick: "Rent, configure, and run a server.", detail: "Rent your own always-on MMORPG server: sizes, costs, mods, and inviting friends.\n\nYou pay only for minutes the server runs, and the world saves when you pause. Share one link and friends jump straight in." },
      { href: "/docs/mmorpg/age-bands", label: "🛡️ Age Bands", quick: "Kid-safe matchmaking by age.", detail: "How age bands keep kids playing with kids: what each band allows and how enforcement works.\n\nParents pick the band once and realms enforce it automatically. Reports from the wrong band jump the mod queue." },
