...
export const SITE_NAV_GROUPS: SiteNavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/docs", label: "Docs", quick: "Plain-English help for everything.", detail: "Same Docs Hub as Build — guides for every corner of the site." },
    ],
  },
  {
    label: "Account",
...
export const ALL_SITE_LINKS: SiteNavLink[] = [
  { href: "/games", label: "All Games", quick: "All 34 games — click and play.", detail: "The arcade shelf. See above." },
  ...SITE_NAV_GROUPS.flatMap((g) => g.links),
];
