...
export const SITE_NAV_GROUPS: SiteNavGroup[] = [
  {
    ...
    links: [
      { href: "/mmo", label: "🎮 Play MMO — live servers", quick: "Live servers — cheap seats on the $6 shared server, split by players.", detail: "The realm browser. Find a kid-safe community server, see who is online, and jump in from your browser.\n\nEvery realm lists its age band and rules before you join. Want your own? Rent a server and set the rules yourself." },
      ...
      { href: "/mmo/rent", label: "🖥️ Rent a Realm", quick: "Host your own MMORPG server.", detail: "Your own always-on realm with your rules, your map, and your mods.\n\nPick a size, pay by the minute in Vibe Coins, and invite friends with a link. Pause anytime - the world saves." },
      { href: "/games/servers", label: "🌐 Game Servers", quick: "Find a shard by game and age band.", detail: "The shard browser. Filter by game, age band, and population, see live coins-per-minute quotes and free-play badges.\n\nEvery server lists its age band before you join. Join links carry you straight into the game." },
      { href: "/games/servers/rent", label: "🖥️ Rent a Server", quick: "Five steps to your own shard.", detail: "Rent your own shard in five steps: game, size, age band, subsidy, quote and confirm.\n\nHourly rental prorated per minute. The world saves when you pause." },
    ],
  },
  {
    label: "🛠️ Make Games",
    ...
    links: [
      ...
      { href: "/gamestudio", label: "🎮 GameStudio", quick: "Godot 4.6.1 & 3-panel game hub.", detail: "Unified game development environment combining code editor, asset pipeline, and Godot 4.6.1 engine.\n\nBuild 2D and 3D games with live preview, asset generation, and clean-room game cloning." },
      { href: "/gamestudio/debugplay", label: "🎮 DebugPlay", quick: "Headless game QA & AI bug analyzer.", detail: "Autonomous game testing agent that navigates game worlds, grabs visual frames, and files verified bugs.\n\nSupports interactive human takeover, state save/load checkpoints, and automated diff patches." },
      ...
      { href: "/builder", label: "🧬 Clone Tool", quick: "Desktop & mobile installer builder.", detail: "Visual installer generator producing standalone .exe, .dmg, and .deb packages from 4weird projects.\n\nCustomize icons, splash screens, licenses, and bundled runtimes with zero command-line hassle." },
  ...
  },
  {
    ...
    links: [
      { href: "/agents", label: "👱🏻‍♀️ AI Agents", quick: "Rent helpers that do work for you.", detail: "Hire-a-brain. Agents research, code, and grind boring work. Escrow holds the max, you pay per second used.\n\nPick a helper, set a max budget, and escrow locks only that amount. Unused escrow returns automatically when the job ends." },
      ...
      { href: "/commander", label: "⚡ CryptArt Commander", quick: "Quake-style terminal & CLI engine.", detail: "Full-screen drop-down terminal (Ctrl+Backquote) with 50+ commands for system telemetry and automation.\n\nScript multi-step pipelines, query coin balances, trigger game QA runs, and inspect API endpoints." },
      ...
      { href: "/compute/p2p", label: "⏱️ DonatePersonalSeconds", quick: "P2P WebGPU compute sharing.", detail: "Micro-volunteering network where users share idle CPU/GPU seconds to earn Vibe Coins.\n\nProcesses distributed video renders, sprite compression, and game QA runs via sandboxed Web Workers." },
      ...
      { href: "/squads", label: "🛡️ UnitUnite", quick: "Work teams with shared wallet.", detail: "Squads are teams: shared coins, roles (Lord / Captain / Banker / Watcher), rooms, and Ghost Cash timer.\n\nInvite by username - no emails, no friction. The shared wallet shows every coin in and out, down to the second." },
      { href: "/timer", label: "⏱️ Timer & Work Diary", quick: "Focus timer + auto diary.", detail: "Clock work to the second with screenshot proofs. Ghost Cash IOUs measure debts - no cash value.\n\nOne tap starts the clock; screenshots prove the work. Ghost Cash tracks who owes whom without moving real money." },
      { href: "/tools", label: "🛠️ Free Utilities", quick: "Free on-device browser tools.", detail: "Instant browser utilities with zero signup: SEO analyzer, image compressor, game copywriter, and word counters.\n\nRuns 100% locally on your machine with no metering and no account required." },
    ],
  },
  {
    ...
    links: [
      ...
      { href: "/business/tax", label: "🤖 Tax Info Bot", quick: "Freelance tax calculator & receipts.", detail: "Autonomous tax and expense organizer for digital creators, freelancers, and game developers.\n\nEstimates quarterly taxes, parses receipt images, categorizes business write-offs, and exports clean CSVs." },
      { href: "/squads", label: "🛡️ UnitUnite", quick: "Work teams with shared wallet.", detail: "Squads are teams: shared coins, roles, rooms, projects, and metered cloud.\n\nRoles keep permissions obvious - Lords own, Captains run, Bankers pay, Watchers observe. Every action lands in the team diary." },
      { href: "/timer", label: "⏱️ Timer & Work Diary", quick: "Focus timer + auto diary.", detail: "Clock work to the second with screenshot proofs. Ghost Cash IOUs measure debts - no cash value.\n\nDiaries export to invoices in one tap, so tracked time becomes billable time. Breaks pause the clock automatically." },
      { href: "/vault", label: "🗄️ Data Vault", quick: "Private files for teams.", detail: "Blob-based file storage with personal, team, and org scopes, strictly separated.\n\nTeam and org folders inherit roles automatically. The audit log shows who opened what, forever." },
    ],
  },
  {
    label: "🎨 Art & 3D",
    ...
    links: [
      { href: "/studio/video", label: "📺 Media Mogul", quick: "Browser NLE video editing & multi-track timeline.", detail: "Professional multi-track video editing, DaVinci color grading, and AI auto-edit studio with zero hardcoded limits.\n\nCut, trim, arrange tracks, add transitions, and export high-bitrate video directly in your browser." },
      { href: "/studio/paint", label: "🎨 DictatePic", quick: "Layered raster drawing & AI inpaint.", detail: "GIMP-style layered image editor with drawing tools, blend modes, and voice-guided AI inpainting.\n\nDraw game sprites, tweak textures, and composite layered artwork with full undo history." },
      { href: "/studio/recorder", label: "🎥 DemoRecorder", quick: "Screen recording & AI input logger.", detail: "Record screens, windows, and webcam while logging frame-accurate keyboard and mouse inputs for AI training.\n\nExport high-FPS webm/mp4 video and structured JSON input datasets in one click." },
      { href: "/studio/audio", label: "🗣️ AliveSpeech Lab", quick: "Voice cloning & audio mastering.", detail: "Multi-voice dialogue generation powered by ElevenLabs and EBU R128 web audio mastering at -14 LUFS.\n\nGenerate character voiceovers, podcasts, and frame-accurate SRT subtitle tracks." },
      { href: "/luck", label: "🍀 Luck Factory", quick: "Intention meditation & luck seeds.", detail: "Cryptographic intention hashing and quantum luck seed synthesizer for game RNG and AI prompts.\n\nSet an intention, meditate on your goal, and anchor deterministic seeds across all 4weird arcade games." },
      { href: "/pet", label: "🐶 Virtual Pet Room", quick: "Interactive 3D companion creature.", detail: "A living 3D virtual companion built in Three.js that lives in your room, plays games, and learns your habits.\n\nFeed, pet, customize decorations, and chat with your companion using AliveSpeech." },
      ...
      { href: "/game/spaceships", label: "🛸 Spaceships", quick: "Collectible ships for your profile.", detail: "Goofy-serious ships to collect and show off across the arcade.\n\nRare ships drop from events, never from stores. Equip one and it flies beside your name everywhere." },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/vocrehab", label: "🧭 Voc Rehab", quick: "Play-first work exploration — scenarios, XP lessons, your data to keep.", detail: "Figure out work at your pace: play short work scenarios, rehearse conversations out loud, and sketch decisions visually. Bite-size lessons earn XP and badges — no exam energy, retry anything.\n\nTeaching sketches only, never a benefits promise or a label. Runs save only when you ask, and your export (JSON or CSV) is yours to take." },
      { href: "/tech", label: "⚙️ Technology", quick: "How the magic works, simply.", detail: "Peek behind the curtain: Next.js, Supabase, RunPod, and robots - in human words.\n\nNo jargon without a translation next to it. Each page links the real code and the live demo it describes." },
      ...
      { href: "/docs/future-proof-web", label: "🏗️ Future-Proof Web", quick: "Architecture risks, on the record.", detail: "Every bad website-architecture decision we found, with severity and fix status: terminal vs server-exec confusion, desktop coupling, swarm state limits, route sprawl.\n\nBreaking items are filed to their owning lanes; doc-level items are fixed inline. For builders, not first-day setup." },
      { href: "/docs/mmo", label: "🐉 MMORPG Guide", quick: "Realms, roles, and kid-safe play.", detail: "How MMORPG realms work: picking a server, age bands, and staying safe while playing with others.\n\nStart with a public realm that matches your age band. Every realm shows its rules before you join, and mods keep the peace." },
      { href: "/docs/mmo/hosting", label: "🖥️ Hosting a Realm", quick: "Rent, configure, and run a server.", detail: "Rent your own always-on MMORPG server: sizes, costs, mods, and inviting friends.\n\nYou pay only for minutes the server runs, and the world saves when you pause. Share one link and friends jump straight in." },
      { href: "/docs/mmo/age-bands", label: "🛡️ Age Bands", quick: "Kid-safe matchmaking by age.", detail: "How age bands keep kids playing with kids: what each band allows and how enforcement works.\n\nParents pick the band once and realms enforce it automatically. Reports from the wrong band jump the mod queue." },
      { href: "/docs/mmo/player", label: "🎮 MMO Player Guide", quick: "Join a shard, split the meter.", detail: "How to join an MMO shard: check the age band first, split server + load per minute with the room, and play free in kids and host-treated rooms.\n\n100 coins is exactly $1.00." },
      { href: "/docs/mmo/host", label: "🖥️ MMO Host Guide", quick: "Rent a world, set the subsidy.", detail: "How to rent an MMO server: pick a game and age band, set the hostFree subsidy, and pay the hourly rental prorated per minute.\n\nPopulation defaults to 32 players." },
      { href: "/docs/mmo/safety", label: "🛡️ MMO Safety", quick: "Three bands, kid-safe shards.", detail: "How MMO shards stay kid-safe: three age bands, birthdays checked in memory and never stored, 140-character chat limits, and in-product reporting." },
      { href: "/docs/mmo/faq", label: "❓ MMO FAQ", quick: "Billing and access answers.", detail: "MMO billing and access answers: why per-minute metering, what 402 and 403 mean, quote-mismatch retries, and what happens when the host runs dry." },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/family/login", label: "👨‍👩‍👧‍👦 Family Login", quick: "Parent-managed child sign-in.", detail: "For families only: parents create a username#1234 handle from Account → Family, then the child signs in here. No email needed.\n\nKept out of the main nav on purpose — kids can never spend coins without approval." },
