...
import { GAME_AI_COMPUTE_CUT_PCT, WORKSPACE_COMPUTE_CUT_PCT, workspaceComputeSplit } from "@/lib/economy";
...
export const CLOUD_SERVICES: CloudService[] = [
  ...
  { key: "vcw-autoplay-gpu-boosted", name: "VCW Autoplay (GPU boosted)", unit: "remote_min", coinsPerUnit: 2.2, blurb: "Pinned RTX 4090 (5090 fallback): fastest game vision for 4weird games, required for Xonotic off-site, ~$1.32/hr gross ceiling quoted exactly at start (desktop app required off-site)", category: "Game AI", tier: "rtx-4090-pinned", runtime: "cuda-newest-viable" },
  ...
  { key: "fal-upscale-hd", name: "fal HD Upscale", unit: "image", coinsPerUnit: 6, blurb: "Remaster pixel art + screenshots to crisp HD (topaz/upscale/image)", category: "fal.ai Media", tier: "turbo", runtime: "topaz-upscale" },
  ...
  { key: "fal-render-3d", name: "fal 3D Prop", unit: "model", coinsPerUnit: 15, blurb: "One sketch into a spinnable 3D prop (trellis)", category: "fal.ai Media", tier: "turbo", runtime: "trellis-3d" },
  { key: "fal-trailer-clip", name: "fal Trailer Clip", unit: "clip", coinsPerUnit: 25, blurb: "Cinematic teaser trailers from one sentence (kling-video/v3/pro)", category: "fal.ai Media", tier: "pro", runtime: "kling-v3-pro" },
  ...
  { key: "fal-theme-music", name: "fal Theme Music", unit: "clip", coinsPerUnit: 10, blurb: "Menu loops + boss themes that never loop awkwardly (musicgen/medium)", category: "fal.ai Media", tier: "turbo", runtime: "musicgen-medium" },
  ...
  { key: "fal-backdrop-wide", name: "fal World Backdrop", unit: "image", coinsPerUnit: 9, blurb: "Ultra-wide parallax backdrops: skies, dungeons, neon cities (imagen4/preview)", category: "fal.ai Media", tier: "turbo", runtime: "imagen4-preview" },
  { key: "fal-character-turn", name: "fal Character Turnaround", unit: "image", coinsPerUnit: 9, blurb: "Front/side/back turnaround sheets for heroes + NPCs (hidream-i1-full)", category: "fal.ai Media", tier: "turbo", runtime: "hidream-i1-full" },
  ...
  { key: "fal-voxel-prop", name: "fal Voxel Prop 3D", unit: "model", coinsPerUnit: 15, blurb: "Chunky voxel props from one sketch (tripo3d/h3.1/image-to-3d)", category: "fal.ai Media", tier: "turbo", runtime: "tripo3d-h3.1" },
  { key: "fal-text-to-3d", name: "fal Text 3D Prop", unit: "model", coinsPerUnit: 16, blurb: "Type a prop, get a spinnable 3D model (tripo3d/h3.1/text-to-3d)", category: "fal.ai Media", tier: "turbo", runtime: "tripo3d-text-3d" },
  ...
  { key: "fal-motion-loop", name: "fal Motion Loop", unit: "clip", coinsPerUnit: 20, blurb: "Any sprite or portrait into a looping motion clip (kling-video/v2.5-turbo)", category: "fal.ai Media", tier: "pro", runtime: "kling-2.5-turbo" },
  ...
  { key: "fal-ambient-bed", name: "fal Ambient Bed", unit: "clip", coinsPerUnit: 7, blurb: "Rain, tavern hum, spaceship drones; looping ambience (mmaudio-v2/text-to-audio)", category: "fal.ai Media", tier: "turbo", runtime: "mmaudio-v2" },
  { key: "fal-chiptune-loop", name: "fal Chiptune Loop", unit: "clip", coinsPerUnit: 8, blurb: "8-bit chiptune loops that never loop awkwardly (yue/text-to-music)", category: "fal.ai Media", tier: "turbo", runtime: "yue-music" },
  { key: "fal-quest-dialogue", name: "fal Quest Dialogue", unit: "quest", coinsPerUnit: 3, blurb: "Branching quest dialogue trees from one story beat (openai/gpt-oss-120b)", category: "fal.ai Media", tier: "turbo", runtime: "gpt-oss-120b" },
  { key: "fal-code-review", name: "fal Code Review", unit: "review", coinsPerUnit: 3, blurb: "Instant gameplay code review; balance, bugs + fix list (moonshotai/kimi-k2-instruct)", category: "fal.ai Media", tier: "turbo", runtime: "kimi-k2-instruct" },
  ...
  { key: "do-volume", name: "DO Block Volume", unit: "gb_mo", coinsPerUnit: 14, blurb: "Persistent SSD volumes attached to droplets ($0.10/GB-mo provider + 25% cut, ceiled to whole coins)", category: "Long-term", tier: "standard-10gb", runtime: "ext4-newest", providerHint: "digitalocean" },
...
export const GAME_AI_CUT_NOTE = `Includes ${GAME_AI_COMPUTE_CUT_PCT}% game-AI compute cut; never added on top.`;
