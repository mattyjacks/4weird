...
export const CLOUD_SERVICES: CloudService[] = [
  ...
  { key: "fal-voxel-prop", name: "fal Voxel Prop 3D", unit: "model", coinsPerUnit: 15, blurb: "Chunky voxel props from one sketch (hunyuan3d-v21/image-to-3d)", category: "fal.ai Media", tier: "turbo", runtime: "hunyuan3d-v21" },
