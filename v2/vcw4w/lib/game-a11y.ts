...
const TABLE: Record<string, GameA11y> = {
  overtake: {
    ...
    photosensitive: true,
    readingHeavy: false,
    controls: "Arrows / WASD steer · Space / Shift / N nitro · R restart · P or Esc pause",
  ...
  gravegain3d: {
    ...
    photosensitive: true,
    readingHeavy: false,
    controls: "WASD move · Mouse or arrows look · Left-click melee/skill · Right-click block · F ability · Space jump · Q potion · E buildings",
  ...
  assassinanimals: {
    ...
    photosensitive: false,
    readingHeavy: false,
    controls: "WASD sneak · Left-click / Space strike · Q coin · E takedown/interact · G drag body · 1-5 gadgets",
  ...
  aiwhackamole: {
    ...
    photosensitive: true,
    readingHeavy: true,
    controls: "Click / tap rogue AIs · Spare the helpful ones · Chain combos to x5 · P or Esc pause",
