...
export const PERMISSION_CATALOG: PermissionDef[] = [
  ...
  { key: "team.projects.create", group: "team", label: "Create projects", blurb: "Open GitHub-like projects" },
  { key: "team.projects.delete", group: "team", label: "Delete projects", blurb: "Remove projects" },
  { key: "team.rooms.create", group: "team", label: "Create rooms", blurb: "Open Matrix-like secure rooms" },
  ...
  { key: "security.devices.view", group: "security", label: "View devices", blurb: "Matrix-style device list" },
...
export const GROUP_LABELS: Record<PermissionGroup, string> = {
  ...
  rooms: "UnitUnite messaging (Matrix-style E2EE)",
