...
const TABLE: Record<string, GamePlaybook> = {
  "platform-wars": {
    slug: "platform-wars",
    controls: "Desktop: A/D or arrows move · W/Space jump · F dash · Phone: on-screen pad · No pause key (Leave exits; rounds ~90s)",
    goal: "Out-score the rival platform team in quick-match arena rounds.",
    boot: ["Pick Quick Match and choose a side (phone agility vs desktop precision).", "Click the arena to focus keyboard before the round starts.", "Move immediately; rounds start fast and there is no pause — Leave exits the match."],
  ...
  serversavershield: {
    ...
    controls: "Mouse / touch moves the shield · Click / tap / Space toggles beams · WASD / arrows reposition · P or Esc pause · Shop Zone buys Emergency Repair",
    goal: "Defend the data centers from malware bots, DDoS waves, and viruses; spend earnings in the Shop / Management Zone to survive.",
    boot: ["Click the game to focus, then sweep the shield across the first wave.", "Click once to toggle beams on when malware appears (click again to stop).", "Save coins for Emergency Repair (+50 HP) before DDoS spikes."],
  ...
  assassinanimals: {
    ...
    controls: "WASD sneak · Left-click / Space strike · Right-click / Q toss coin · E takedown/interact (hold E: hack/pickpocket) · G drag body · Shift/F ability · 1/2/3 + 4/5 gadgets · P or Esc pause",
  ...
  gravegain3d: {
    ...
    boot: ["Click Endless Dungeon Run, pick a build, and choose Deploy.", "Click the canvas once to lock the pointer (first click locks, next swings).", "Drink a potion (Q) under half health and bank loot at the hub between floors."],
  ...
  demolichdom: {
    slug: "demolichdom",
    controls: "WASD / arrows move necromancer · Click skull spell · S summon skeleton (-25 mana) · P or Esc pause · Blink button on mobile",
  ...
  fridgesimulator: {
    ...
    controls: "Click buy / manage fridges · Next Day button or Space/N · P or Esc pause",
  ...
  orbitaldrift: {
    slug: "orbitaldrift",
    controls: "Hold Space / click / touch for thrust · Release to drift back · 1/2/3 ships · M mute · P or Esc pause",
  ...
  aiwhackamole: {
    slug: "aiwhackamole",
    controls: "Click / tap rogue AIs · Spare helpful ones · Combos to x5 · P or Esc pause",
  ...
  soundpainter: {
    slug: "soundpainter",
    controls: "Click tiles to paint sound+color · Space plays all · R resets · P or Esc pause",
  ...
  "temple-of-lost-revenue": {
    ...
    boot: ["Guide the cat down the first corridor and grab one pickup.", "Stand near a door and hold Shift to decipher (touch: use the shell Decipher button at doors).", "Clear one room fully before pushing deeper."],
