# AIPlay Local REST API & SDK Reference Guide

The **AIPlay Local REST API** allows AI agents (such as Gemini), CLI scripts, and developer tools to control, inspect, playtest, patch, and debug HTML5 games running in the 4weird platform.
...
```bash
node ai/v1/aiplay/start_api_server.js
```
...
## 📦 Node.js SDK Usage (`aiplay_client.js`)
