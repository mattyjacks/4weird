...
cp /opt/vibecodeworker/repo/ai/v1/vibecodeworker/deploy/docker-compose.cloud.yml /opt/vibecodeworker/docker-compose.yml
...
```bash
node heal_worker.js --test-command "node test_vibecodeworker.js" --dir /app/ai/v1/vibecodeworker
```
